...
{
    public class AuthenticationGoogleHandler : AuthenticationHandler<TokenAuthSchemeOptions>
    {
        private readonly ISsoService _ssoService;
        private readonly IHttpContextAccessor _httpContext;
        public AuthenticationGoogleHandler(IHttpContextAccessor httpContext, ISsoService ssoService, IOptionsMonitor<TokenAuthSchemeOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock) 
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            var jsonString = await _ssoService.SsoGoogleTokenVerify(accessToken);
