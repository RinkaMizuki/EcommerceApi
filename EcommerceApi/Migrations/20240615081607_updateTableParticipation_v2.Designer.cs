...
namespace EcommerceApi.Migrations
{
    ...
    [Migration("20240615081607_updateTableParticipation_v2")]
    partial class updateTableParticipation_v2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceApi.Models.Chat.Conversation", b =>
                {
            ...
            modelBuilder.Entity("EcommerceApi.Models.Chat.Message", b =>
                {
                    ...
                    b.HasIndex("SeenderId");

                    b.ToTable("Messages");
                });

            modelBuilder.Entity("EcommerceApi.Models.Chat.Participation", b =>
                {
            ...
            modelBuilder.Entity("EcommerceApi.Models.Chat.Message", b =>
                {
                    ...
                    b.HasOne("EcommerceApi.Models.Chat.Message", "OriginalMessage")
                        .WithMany("ListMessageChild")
                        .HasForeignKey("OriginalMessageId");

                    b.HasOne("EcommerceApi.Models.UserAddress.User", "Seender")
                        .WithMany()
                        .HasForeignKey("SeenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
